...
# we flipped 
key_pins = (board.GP0, board.GP2, board.GP4, board.GP6,
...
# flip A & B
encoderB_pin, encoderA_pin, encoderSW_pin = board.GP18, board.GP19, board.GP28 # was 22
