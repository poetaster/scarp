...
struct sample_t {
  ...
  char sname[20];        // sample name
	...
	B2snare,	// pointer to sample array
	B2snare_SIZE,	// size of the sample array
	B2snare_SIZE,	//sampleindex. if at end of sample array sound is not playing
	...
	C3snare,	// pointer to sample array
	C3snare_SIZE,	// size of the sample array
	C3snare_SIZE,	//sampleindex. if at end of sample array sound is not playing
	...
	D4snare,	// pointer to sample array
	D4snare_SIZE,	// size of the sample array
	D4snare_SIZE,	//sampleindex. if at end of sample array sound is not playing
